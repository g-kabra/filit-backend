...
class GoldRatesModel(models.Model):
    ...
    expiry = models.DateTimeField(default=datetime.strptime(
...
class GoldAddressModel(models.Model):
    gold_user_id = models.ForeignKey(GoldInvestorModel, on_delete=models.CASCADE)
...
class GoldTransactionModel(models.Model):
    ...
    bank_id = models.ForeignKey(GoldBankModel, to_field="bank_id", null=True, on_delete=models.SET_NULL)
